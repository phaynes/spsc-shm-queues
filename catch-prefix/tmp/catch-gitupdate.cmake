...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "tmx-base"
  WORKING_DIRECTORY "/Users/philiphaynes/devel/spscmqueue/cpp/catch-prefix/src/catch"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("tmx-base" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/tmx-base")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/philiphaynes/devel/spscmqueue/cpp/catch-prefix/src/catch'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/philiphaynes/devel/spscmqueue/cpp/catch-prefix/src/catch'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
